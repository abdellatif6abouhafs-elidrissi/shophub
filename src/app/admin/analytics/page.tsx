        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-sm font-medium text-gray-500">Highest Order</p>
              </div>
              <p className="text-3xl font-bold text-gray-900">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-sm font-medium text-gray-500">Lowest Order</p>
              </div>
              <p className="text-3xl font-bold text-gray-900">
                      ...
                      >
                        <div className="relative w-full flex justify-center group">
                          <motion.div
                            ...
                            className="w-full max-w-8 bg-primary-500 rounded-t-sm hover:bg-primary-600 transition-colors cursor-pointer"
                            style={{ minHeight: '4px' }}
                          />
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Revenue by Payment Method</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
